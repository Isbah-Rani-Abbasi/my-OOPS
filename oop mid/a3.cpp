...
bool efficiencyComparison(Vehicle &v1, Vehicle &v2) {
    ...
    if (ve1 > ve2) {
        cout << "According to AI Conflict Resolution System, Vehicle " << v1.id << " is more suitable for executing the task!" << endl;
        return true;
    } else {
        cout << "According to AI Conflict Resolution System, Vehicle " << v2.id << " is more suitable for executing the task!" << endl;
        return false;
    }
}
